...
4. **Route to mature lenses.** Use systems-engineering, DSM, feedback-control, STPA, domain science, experiments, statistics, or other external methods only when their activation conditions fit.
