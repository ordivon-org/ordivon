...
[`CONSUMPTION_BOUNDARY_R1.md`](CONSUMPTION_BOUNDARY_R1.md) records where a policy evaluator is appropriate and, more importantly, where it must **not** be inserted. Runtime, Host, Harness core, Network and Research remain directly owned by their native authority models; OPA is not a new global waist.
