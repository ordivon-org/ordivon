...
Do not infer live deployment health, release provenance, or a SLSA level from this repository recipe. Those claims require an actual installed/built subject and its own evidence.
