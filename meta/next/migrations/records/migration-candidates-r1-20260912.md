...
| `ordivon-host-v2@756a38412a19` | clean active minimal continuity/work-state utility; systemd active+enabled; local pytest green on 2026-09-14 | retained narrow capability provider; broad Host/Board semantics remain retired | **REGISTER_PROVIDER + RETAIN_MINIMAL_ACTIVE** | replacing a small working continuity utility with Plane/MAF is not justified by current workload or resource economics; use Temporal/n8n/Runtime/MAF/Plane only for responsibilities they independently earn |
