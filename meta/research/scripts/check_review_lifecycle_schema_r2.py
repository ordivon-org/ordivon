...
SCHEMA = META / "research/schemas/review-lifecycle-observation-v2.schema.json"
MAP = META / "research/data/review-lifecycle-evidence-map-r2.json"
ARIES = META / "research/evidence/aries-bounded-core-r1.json"
DISAPERE = META / "research/evidence/disapere-bounded-core-r1.json"
PEERSUM = META / "research/evidence/peersum-hf-bounded-core-r1.json"
