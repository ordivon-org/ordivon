...
- [`docs/GAME_R1_DIRECT_PLAY_ACCESS_20260911.md`](docs/GAME_R1_DIRECT_PLAY_ACCESS_20260911.md) owns the current direct-play access census and human gate; [`docs/GAME_R1_DIRECT_PLAY_OBSERVATION_SHEET.md`](docs/GAME_R1_DIRECT_PLAY_OBSERVATION_SHEET.md) is the blank session carrier. No download, purchase, account sign-in or Human evidence is implied by their existence.
