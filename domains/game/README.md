...
- [`docs/GAME_R0_REFERENCE_STACKS_20260911.md`](docs/GAME_R0_REFERENCE_STACKS_20260911.md) owns current R0-C: flagship/canonical/cheap-causal stacks and the first broad R1 **reference-teardown-only** wave. Clone implementation remains unadmitted.
