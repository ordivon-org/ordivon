...
- [`docs/GAME_R0_EXTERNAL_REFERENCE_CLASS_20260911.md`](docs/GAME_R0_EXTERNAL_REFERENCE_CLASS_20260911.md) is the current executed R0 corpus: it separates success from production-baseline comparability and admits Balatro, Vampire Survivors, and Mini Metro as the first teardown set without selecting a product or entering G0.
