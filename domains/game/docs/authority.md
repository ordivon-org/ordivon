...
audience:
  ...
  - agent
updated: 2026-08-17
summary: Decision separating registered Station Zero execution, canonical G0-G8 product lifecycle authority, Game Core treatments, the R1–R29 foundations corpus, v3 reference evidence, exact P0-P3 contracts, long-range Game vision, and machine truth.
...
[`../README.md`](../README.md) is the canonical repository entry and must state which Scenario and Ruleset are registered. [`PRODUCT.md`](PRODUCT.md) owns the registered Station Zero player experience and acceptance. [`ARCHITECTURE.md`](ARCHITECTURE.md) owns the registered executable architecture and state ownership. [`VISION.md`](VISION.md) owns long-range principles and possibilities but creates no feature commitment. [`DEVELOPMENT_MODEL.md`](DEVELOPMENT_MODEL.md) owns the Game-specific G0–G8 commitment/stage projection and is the **only Game authority for G0–G8 product-stage semantics**; it is not a generic software lifecycle authority and is profiled over the adopted ISO/IEC/IEEE 12207:2026 lifecycle framework. [`GAME_DEVELOPMENT_CORE.md`](GAME_DEVELOPMENT_CORE.md) owns the current cross-game development responsibility/evidence projection underneath those stages; it creates no product stage, Foundation or repository service. [`GAME_DEVELOPMENT_PARADIGM_RESEARCH.md`](GAME_DEVELOPMENT_PARADIGM_RESEARCH.md) owns the historical/current external-paradigm comparison and gap analysis; it is research evidence, not stage or product authority. [`GAME_EXTERNAL_MATURE_PRACTICE_ADOPTION_R1.md`](GAME_EXTERNAL_MATURE_PRACTICE_ADOPTION_R1.md) owns the current **direct-adoption policy**: mature external standards and platform-native mechanisms remain authoritative inside their native scope, while Game owns only Game-specific profiles, semantics, routing and product interpretation. It creates no compliance certificate, external-standard fork, experimentation platform, analytics warehouse, SBOM/provenance standard or platform release workflow. [`GAME_DEVELOPMENT_CASE_PRESSURE_TESTS.md`](GAME_DEVELOPMENT_CASE_PRESSURE_TESTS.md) owns the current real-development-history falsification pass over D1–D8. [`GAME_CONTENT_PROGRESSION_ARCHITECTURE.md`](GAME_CONTENT_PROGRESSION_ARCHITECTURE.md) owns the current derived D5 construction model; neither creates product stage, Foundation, content database or runtime schema. [`GAME_PLAYER_EVIDENCE_PROGRAMME.md`](GAME_PLAYER_EVIDENCE_PROGRAMME.md) owns the current derived player-evidence ecology and claim-scope guards; it creates no Human truth store, analytics platform or product authority. [`GAME_PRODUCTION_AGENT_ENVIRONMENT.md`](GAME_PRODUCTION_AGENT_ENVIRONMENT.md) owns the current external production-environment comparison and consume/adapt/fork/own decision model; it creates no engine/editor ownership or global tool choice. [`GAME_CORE_RESEARCH_RESET.md`](GAME_CORE_RESEARCH_RESET.md), [`GAME_CORE_DIRECTION_SPACE.md`](GAME_CORE_DIRECTION_SPACE.md), [`GAME_CORE_EXPERIMENT_FINDINGS.md`](GAME_CORE_EXPERIMENT_FINDINGS.md), and [`GAME_CORE_EXPERIMENT_CASEFILE.md`](GAME_CORE_EXPERIMENT_CASEFILE.md) own the earlier Game Core research decisions and executable treatments. [`GAME_FOUNDATIONS_RESEARCH_R1_R17.md`](GAME_FOUNDATIONS_RESEARCH_R1_R17.md) owns the canonical synthesis of the first seventeen completed foundation rounds; [`GAME_FOUNDATIONS_RESEARCH_R18.md`](GAME_FOUNDATIONS_RESEARCH_R18.md) owns the R18 decomposition of motivation, goals, needs, values, preferences, utility and commitment; [`GAME_FOUNDATIONS_RESEARCH_R19.md`](GAME_FOUNDATIONS_RESEARCH_R19.md) owns the R19 decomposition of strategic interdependence, conflict, cooperation, competition, coordination, bargaining, negotiation, commitment, reputation and equilibrium; [`GAME_FOUNDATIONS_RESEARCH_R20.md`](GAME_FOUNDATIONS_RESEARCH_R20.md) owns the R20 decomposition of creation, creativity, construction, expression, authorship, customization, style, tool/material/grammar, curation and co-creation; [`GAME_FOUNDATIONS_RESEARCH_R21.md`](GAME_FOUNDATIONS_RESEARCH_R21.md) owns the R21 decomposition of embodiment, body/avatar/control locus, control/input/command/delegation, skill, affordance, responsiveness, game feel and presence; [`GAME_FOUNDATIONS_RESEARCH_R22.md`](GAME_FOUNDATIONS_RESEARCH_R22.md) owns the R22 decomposition of uncertainty, probability, randomness, ambiguity, risk, luck, variance, determinism, predictability and fairness; [`GAME_FOUNDATIONS_RESEARCH_R23.md`](GAME_FOUNDATIONS_RESEARCH_R23.md) owns the R23 decomposition of temporal frames, sequence/order, simultaneity/concurrency, duration/timing/tempo/rhythm, turns/phases/ticks, temporal windows/deadlines, waiting, persistence, reversibility and temporal agency; [`GAME_FOUNDATIONS_RESEARCH_R24.md`](GAME_FOUNDATIONS_RESEARCH_R24.md) owns the R24 decomposition of entity identity, self, character, persona, role, social/collective identity, identifiers, recognition, status, rank, reputation, continuity, transformation, cloning and generative identity; [`GAME_FOUNDATIONS_RESEARCH_R25.md`](GAME_FOUNDATIONS_RESEARCH_R25.md) owns the R25 decomposition of persistent relationships, directed/shared/institutional relational state, attachment, care, intimacy, trust, reliability, commitment, loyalty, obligation, reciprocity, dependence, communal/exchange norms, rivalry, betrayal, repair and social-network topology; [`GAME_FOUNDATIONS_RESEARCH_R26.md`](GAME_FOUNDATIONS_RESEARCH_R26.md) owns the R26 decomposition of affect, emotion episodes, feeling, mood, valence, arousal, appraisal, action tendencies, regulation, expression and empathy; [`GAME_FOUNDATIONS_RESEARCH_R27.md`](GAME_FOUNDATIONS_RESEARCH_R27.md) owns the R27 synthesis of learning, adaptation, memory, belief revision, skill/habit, personality, self-model and persistent Subject change; [`GAME_FOUNDATIONS_RESEARCH_R28.md`](GAME_FOUNDATIONS_RESEARCH_R28.md) owns the R28 decomposition of culture, convention, custom, tradition, ritual, symbol/shared meaning, legitimacy, collective memory, cultural transmission/change and subculture; [`GAME_FOUNDATIONS_RESEARCH_R29.md`](GAME_FOUNDATIONS_RESEARCH_R29.md) owns the R29 whole-corpus synthesis, redundancy/causal-closure audit, Game Foundations v1 semantic-coordinate stack, Foundation Admission/Reopen tests and the provisional stop of foundation expansion; [`GAME_FOUNDATIONS_RESEARCH_MAP.md`](GAME_FOUNDATIONS_RESEARCH_MAP.md) owns the compact R1–R29 navigation model; [`GAME_FOUNDATIONS_CONTINUATION.md`](GAME_FOUNDATIONS_CONTINUATION.md) owns the context-switch handoff and exact next foundation frontier. None of these research records assigns a product stage or selects a shipped product.
...
The registered Station Zero executable, v3 reference experiment, Concept Lab, Casefile and Pre-G0 playables are deliberately separate. Existing experiments are retained apparatus/reference evidence and receive no new product momentum from the current Game Development Core programme. No recent treatment is a selected product winner. The R1–R29 foundations corpus is durable repository state rather than conversation-only context. R29 synthesizes R1–R28 into provisional Game Foundations v1: Entity/Reference, State, Relation, Transition/Constraint, Time, Authority/Provenance, Observation/Representation, Evaluation/Motivation and Action/Capability/Policy/Control are the smallest currently justified semantic coordinate families; World, Subject, Resource/Economy, Risk, Strategy, Creation/Narrative, Identity/Self-model, Relationship, Institution/SocialNorm, Emotion, Learning and Culture are typed derived views/compositions where useful; PlayerValue/Playable-X are design/meta criteria; implementation mechanisms remain separate. R29 also narrows R15 generic Norm to SocialNorm, compresses typed Topology/Causality/Authority/Contract/Playable families and finds no forced independent foundation in the tested morality/language/politics/law/religion/education/technology/ideology falsifiers. The foundation-expansion programme is provisionally frozen. The exact next frontier is Pre-G0 Game Direction Search; Foundations reopen only under the R29 FoundationReopenCondition. DEVELOPMENT_MODEL.md remains sole authority for G0–G8 semantics, and no product has yet been selected. `STATION_ZERO_V3_PRODUCT.md` preserves v3 reference identity and historical programme evidence; P0/P1/P2/P3 remain canonical for their exact owner-local contracts.
