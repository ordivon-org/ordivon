...
const render = readFileSync(new URL("../web/render.js", import.meta.url), "utf8");
...
test("Product Value lane is canonical navigation and has a repeatable evaluator", () => {
  ...
  assert.equal(packageJson.scripts["eval:v3:product-value"], "node experiments/station-zero-v3/scripts/eval-station-zero-v3-product-value.ts");
  assert.equal(packageJson.scripts["eval:v3:product-value:information"], "node experiments/station-zero-v3/scripts/eval-station-zero-v3-product-value.ts --lane information");
  assert.equal(packageJson.scripts["eval:v3:product-value:targeted-controls"], "node experiments/station-zero-v3/scripts/eval-station-zero-v3-product-value.ts --lane targeted-controls");
  const evaluatorSource = readFileSync(new URL("../../../experiments/station-zero-v3/scripts/eval-station-zero-v3-product-value.ts", import.meta.url), "utf8");
