...
for aid in sorted(agents):
    ...
    t=cp.stdout
    for need in [f'AGENT_ID = {aid}',f'roles/{aid}.json','Independence before first verdict','Human boundary','POST_CONVERGENCE_TEST']:
...
print('closure_coverage=46/46 human_unknown_guards=7 scope_pressure_schema=present')
