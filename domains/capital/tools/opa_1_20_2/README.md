# OPA 1.20.2 historical challenger

This directory preserves the exact Rego policy used before the 2026-09-21 comparative qualification.

Comparative evidence:
- 354 deterministic policy cases;
- 0 mismatches against a small direct Python baseline;
- current integration style used a local subprocess for each decision;
