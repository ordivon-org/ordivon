...
def test_fill_consumes_effect_authority():
 ...
 assert x['standing']=='POSITIVE_EXECUTION'; assert x['effectDisposition']=='CONSUME'
...
def test_open_order_retains_effect_authority():
 ...
 assert x['standing']=='PARTIAL_OPEN'; assert x['effectDisposition']=='RETAIN'
...
def test_exact_authoritative_negative_lookup_can_release():
 ...
 assert x['standing']=='PROVEN_NO_EFFECT'; assert x['effectDisposition']=='RELEASE'
