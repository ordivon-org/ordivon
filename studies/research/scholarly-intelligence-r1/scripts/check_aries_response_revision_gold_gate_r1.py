...
SUBSTRATE = (
    STUDY / "evidence/aries-response-revision-annotation-substrate-r1.json"
)
ATTEMPT = (
    STUDY / "evidence/aries-response-revision-coder-campaign-attempt-r1.json"
)
PLAN = STUDY / "campaigns/aries-response-revision-r1/campaign-plan.json"
A_SPEC = STUDY / "campaigns/aries-response-revision-r1/coder-a-campaign.json"
B_SPEC = STUDY / "campaigns/aries-response-revision-r1/coder-b-campaign.json"
