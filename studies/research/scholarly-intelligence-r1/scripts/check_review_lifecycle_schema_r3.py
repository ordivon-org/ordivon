...
SCHEMA = STUDY / "schemas/review-lifecycle-observation-v3.schema.json"
MAP = STUDY / "data/review-lifecycle-evidence-map-r3.json"
ARIES = STUDY / "evidence/aries-bounded-core-r1.json"
RESP = STUDY / "evidence/aries-review-response-core-r1.json"
