...
PLAN = STUDY / "pressure-tests/claim-permission-maturity-gate-r1.json"
RECEIPT = STUDY / "evidence/claim-permission-maturity-pressure-r1.json"
PAPER2_PROFILE = STUDY / "profiles/paper2-live-r1.json"
