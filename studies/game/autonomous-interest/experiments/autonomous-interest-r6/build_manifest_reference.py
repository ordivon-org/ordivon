...
MANIFEST_KIND = "ordivon.game-autonomous-interest-r6-human-build-manifest"
...
def source_bindings() -> dict:
    return {
        ...
        "modelSchema": file_digest(ROOT / "domains/game/game-autonomous-interest-model-r6.schema.json"),
        "machineProtocol": file_digest(ROOT / "domains/game/game-autonomous-interest-protocol-r6.json"),
    }
