...
class CryptoStreamPrometheusTests(unittest.TestCase):
    def test_metrics_truth_and_safety_boundary(self):
        ...
        self.assertIn('ordivon_market_capital_crypto_stream_reconnect_live_qualified 0',out)
        self.assertIn('ordivon_market_capital_crypto_surfpath_control_plane_blocked 1',out)
