...
5. Temporal Nexus service contracts for cross-E2E durable operations.
6. OpenTelemetry propagation into the existing Prometheus/Vector/Loki/Grafana Operations stack.
7. Host active-state migration and read-only archival, then Host retirement.
