...
Node graph: `catalogs/knowledge/graphs/ordivon-agent-birth-r1.json`
...
Detailed evidence and routing law: `catalogs/knowledge/lessons/agent-birth-provider-boundary-r1.md`.
