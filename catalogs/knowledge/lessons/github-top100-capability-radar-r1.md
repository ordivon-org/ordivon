...
| 63 | `x1xhlol/system-prompts-and-models-of-ai-tools` | 143,606 | GPL-3.0 | Prompt/tool behavior corpus | **STUDIED_AVOID** | Full deep-study PASS: valuable mixed-provenance Agent behavior/tool corpus for comparative research and threat modeling; quarantine as secondary evidence, not Prompt Authority. See `system-prompts-corpus-deep-architecture-study.md`. |
