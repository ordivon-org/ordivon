...
See `catalogs/capabilities/providers/mcp.md`, `catalogs/knowledge/lessons/mcp-interoperability-kernel.md`, `catalogs/capabilities/providers/temporal.md`, and `catalogs/knowledge/lessons/temporal-durable-execution-kernel.md`.
