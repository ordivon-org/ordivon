...
class ArtifactOpenXmlEnvironmentTests(unittest.TestCase):
    ...
    def test_production_defaults_do_not_point_to_repo_local_dotnet_or_validator_build(self):
        delivery=(ROOT/'scripts/artifact_delivery.py').read_text();doctor=(ROOT/'scripts/artifact_delivery_toolchain_doctor.py').read_text()
        ...
        self.assertIn('artifact-openxml-v1/current/bin/validate-openxml',delivery)
