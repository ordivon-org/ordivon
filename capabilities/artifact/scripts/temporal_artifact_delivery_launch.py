...
async def main_async()->int:
    ...
    try: handle=await client.start_workflow(ARTIFACT_DELIVERY_WORKFLOW,value,id=wid,task_queue=a.task_queue,id_reuse_policy=WorkflowIDReusePolicy.REJECT_DUPLICATE,id_conflict_policy=WorkflowIDConflictPolicy.FAIL)
