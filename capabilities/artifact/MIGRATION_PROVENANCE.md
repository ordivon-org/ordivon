...
The historical repository remains Git provenance for pre-split history. `/root/projects/ordivon/capabilities/artifact` is the accepted forward source authority after differential tests, stable-runtime re-materialization, and production-green Temporal workflow acceptance. See `docs/SOURCE_AUTHORITY_ACCEPTANCE_20260912.md`.
