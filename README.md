...
See `meta/next/docs/MONOREPO_M0_ARCHITECTURE.md` for the imported M0 design and `docs/migration/acceptance/SOURCE_MIGRATION_STANDING.md` for current source standing.
