...
Wave B / M1 is admitted for bounded historical validation: the Wave A target portfolio now executes through pinned QuantConnect LEAN with modeled fills, fees and slippage, no broker credentials and no external financial writes. Production/live authorization remains not granted. See `docs/WAVE_B_M1_ACCEPTANCE_2026-09-13.md`.
